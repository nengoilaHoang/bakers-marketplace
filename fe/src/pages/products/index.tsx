...
export default function ProductListPage() {
  ...
  return (
    <div style={page}>
      ...
      <div style={toolbar}>
        <Link href="/products/new" style={buttonPrimary}>
          + Tạo sản phẩm
        </Link>
        <Link href="/products/search" style={button}>
          Tìm kiếm
        </Link>
          ...
          <table style={table}>
            ...
            <tbody>
              {products.map((p) => (
                <tr key={p.id}>
                  <td style={td}>
                    <Link href={`/products/${p.id}`} style={link}>
                      {p.title}
                    </Link>
                  ...
                  <td style={{ ...td, whiteSpace: "nowrap" }}>
                    <div style={row}>
                      <Link href={`/products/${p.id}`} style={button}>
                        Xem
                      </Link>
                      <Link href={`/products/${p.id}/edit`} style={button}>
                        Sửa
                      </Link>
                      <button
                        style={buttonDanger}
